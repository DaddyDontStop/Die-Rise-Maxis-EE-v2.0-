...
custom_pts_putdown_trigs_create_for_spot( s_lion_spot, player )
{
	...
	t_place_ball = sq_pts_create_use_trigger( s_lion_spot.origin, 16, 70, &"ZM_HIGHRISE_SQ_PUTDOWN_BALL" ); // (16,70)
...
//Dragon Puzzle step
//makes floor symbols require as many symbols as players
...
//after a player disconnects during the Maxis Trample Steam step making the number of players be less than 4 and depending on if not enough Trample Steams were on symbols and in inventories, gives the players not carrying Trample Steams the ability to pick up new Trample Steams
